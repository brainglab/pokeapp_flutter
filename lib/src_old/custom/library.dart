...
import 'package:pokeapp_flutter/src_old/pages/form_country_page.dart';
import 'package:pokeapp_flutter/src_old/pages/home_page.dart';
import 'package:pokeapp_flutter/src_old/pages/splash_page.dart';
import 'package:pokeapp_flutter/src_old/widgets/loading.dart';
...
customShowToast(BuildContext context, String message) {
  int mTime = (message.length / 2).round();
