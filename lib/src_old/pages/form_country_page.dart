...
import 'package:pokeapp_flutter/src_old/custom/constants.dart';
import 'package:pokeapp_flutter/src_old/custom/library.dart';
import 'package:pokeapp_flutter/src_old/custom/validation.dart';
import 'package:pokeapp_flutter/src_old/handlers/sqlite_handeler.dart';
import 'package:pokeapp_flutter/src_old/providers/global_provider.dart';
import 'package:pokeapp_flutter/src_old/widgets/custom_button.dart';
import 'package:pokeapp_flutter/src_old/widgets/custom_input.dart';
import 'package:pokeapp_flutter/src_old/widgets/navbar_back.dart';
  ...
  deleteCountry() async {
    try {
      if (Provider.of<GlobalProvider>(context, listen: false).mCountry.mIdx == null) {
        ...
        // delete country into the 'countries' table
        progressDialogShow(globalContext!);
        var db = await mSqliteHandler.getDb();
        await db.delete(
          'countries',
